        ...
        <header className='bg-[#101419] border-b-2 border-[#293038]'>
            <nav className='mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8'>
                ...
                <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                    <ul class="font-bold flex flex-col p-8 md:p-0 md:items-center mt-4 border border-[#e26767] rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0">
                        <li>
                        ...
                        <li>
                            <div className='relative'>
                                ...
                                <input type="text" className='rounded-md border-0 py-1.5 pl-9 text-white bg-[#293038]' placeholder='Buscar'/>
                            </div>
                        </li>
                    </ul>
                </div>
